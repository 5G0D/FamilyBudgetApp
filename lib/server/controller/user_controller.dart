...
class UserController {
  ...
  static Future<UserConfirmEmailResponse?> confirmEmail(
      String userId, String confirmCode, {BuildContext? context}) async {
    Map<String, dynamic> params = {
      'userId': userId,
    ...
    http.Response? response =
        await HttpUtils.post('/api/user/confirmEmail', params: params, context: context);
    if (response != null) {
      return UserConfirmEmailResponse.fromJson(jsonDecode(response.body));
    }
  ...
  static Future<UserResponse?> login(
    ...
    http.Response? response =
        await HttpUtils.post('/api/user/login', params: params, context: context);
    if (response != null) {
  ...
  static Future<UserIdResponse?> update(int id,
      {String? name, String? email, String? password, String? photo, BuildContext? context}) async {
    Map<String, dynamic> params = {
      'id': id,
    };
    ...
    http.Response? response =
        await HttpUtils.post('/api/user/update', params: params, context: context);
    if (response != null) {
      return UserIdResponse.fromJson(jsonDecode(response.body));
    }
  ...
  static Future<UserIdResponse?> passwordRecovery(
    ...
    http.Response? response =
        await HttpUtils.post('/api/user/passwordRecovery', params: params, context: context);
    if (response != null) {
  ...
  static Future<UserResponse?> getUserById(int id, {BuildContext? context}) async {
    Map<String, dynamic> params = {
      'id': id.toString(),
    };

    http.Response? response =
        await HttpUtils.get('/api/user/getUserById', params: params, context: context);
    if (response != null) {
      return UserResponse.fromJson(jsonDecode(response.body));
    }
