...
class UserController {
  static Future<UserIdResponse?> register(
    ...
    try {
      http.Response response =
          await HttpUtils.post('/api/user/register', params: params);
  ...
  static Future<UserConfirmEmailResponse?> confirmEmail(
      BuildContext context, String userId, String confirmCode) async {
    Map<String, dynamic> params = {
      'userId': userId,
    ...
    try {
      http.Response response =
          await HttpUtils.post('/api/user/confirmEmail', params: params);
  ...
  static Future<UserResponse?> login(
    ...
    try {
      http.Response response =
          await HttpUtils.post('/api/user/login', params: params);
  ...
  static Future<UserIdResponse?> update(BuildContext context, int id,
      {String? name, String? email, String? password, String? photo}) async {
    Map<String, dynamic> params = {
      'id': id,
    };
    ...
    try {
      http.Response response =
          await HttpUtils.post('/api/user/update', params: params);
      return UserIdResponse.fromJson(jsonDecode(response.body));
    } on RequestException catch (_) {
      SnackBarUtils.Show(context, HttpUtils.httpError);
    } on SocketException catch (_) {
  ...
  static Future<UserResponse?> getUserById(BuildContext context, int id) async {
    Map<String, dynamic> params = {
      'id': id,
    };
    ...
    try {
      http.Response response =
          await HttpUtils.get('/api/user/getUserById', params: params);
      return UserResponse.fromJson(jsonDecode(response.body));
    } on RequestException catch (_) {
      SnackBarUtils.Show(context, HttpUtils.httpError);
    } on SocketException catch (_) {
